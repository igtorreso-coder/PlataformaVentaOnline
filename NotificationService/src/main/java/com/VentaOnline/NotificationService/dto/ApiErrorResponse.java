...
public class ApiErrorResponse {
    ...
    @Schema(description = "Mensaje descriptivo del error", example = "Tipo inválido")
    private String message;

    @Schema(description = "Ruta del endpoint que generó el error", example = "/api/notificaciones")
    private String path;
