...
public class ApiErrorResponse {
    ...
    @Schema(description = "Mensaje descriptivo del error", example = "Categoría no encontrada")
    private String message;

    @Schema(description = "Ruta del endpoint que generó el error", example = "/api/categorias/99")
    private String path;
