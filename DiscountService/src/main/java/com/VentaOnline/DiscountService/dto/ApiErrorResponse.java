...
public class ApiErrorResponse {
    ...
    @Schema(description = "Mensaje descriptivo del error", example = "Cupón no encontrado")
    private String message;

    @Schema(description = "Ruta del endpoint que generó el error", example = "/api/descuentos/99")
    private String path;
